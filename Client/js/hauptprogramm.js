<div id="mainframe">
  ...
  var Artikel = new Array();
      ...
      Artikel[0]["Artikelnr."] = Artikel.length;
      ...
      Artikel[1]["UVP"] = 4.99;
      Artikel[0]["Artikelnr."] = Artikel.length + 1;
...
<div id="ausgabe_komplett">
<ul>
    <li><button type="button" id="button" >Artiel anzeigen</button></li>
